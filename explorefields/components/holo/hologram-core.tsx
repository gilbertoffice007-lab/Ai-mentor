...
export function HologramCore({ label, title, shape, Icon, onOpen, hint = 'Open overview' }: Props) {
  ...
  return (
    <div className="pointer-events-none relative flex flex-col items-center">
      ...
      <button
        ...
        onClick={onOpen}
        title={hint}
        className="pointer-events-auto group relative grid place-items-center outline-none"
        style={{
      ...
      >
        ...
        <span
          aria-hidden
          className="absolute inset-[-14%] anim-pulse-glow rounded-full blur-2xl"
          style={{ background: 'radial-gradient(circle, color-mix(in oklab, var(--accent) 55%, transparent), transparent 66%)' }}
        />
        ...
        <span
          ...
          style={{ clipPath: shape, background: 'color-mix(in oklab, var(--accent) 60%, transparent)', transition: 'clip-path 600ms ease' }}
        />
        {/* glass interior */}
        <span
          aria-hidden
          className="absolute inset-[3px] overflow-hidden backdrop-blur-md"
          style={{
            clipPath: shape,
            background:
        ...
        >
          ...
          <span
            ...
            style={{ background: 'linear-gradient(90deg, transparent, color-mix(in oklab, var(--accent) 22%, transparent), transparent)' }}
          />
        </span>
        ...
        <span className="relative z-10 flex w-[72%] flex-col items-center gap-1.5 text-center">
          ...
          />
          <span
            className="font-display text-[9px] tracking-[0.34em]"
      ...
      {/* projection beam + base — sits behind the orbit ring */}
      <div aria-hidden className="pointer-events-none absolute top-full -z-10 -mt-1 flex w-full flex-col items-center">
        <div
          ...
          style={{
            ...
            background: 'linear-gradient(to bottom, color-mix(in oklab, var(--accent) 55%, transparent), transparent 88%)',
          }}
        />
        <div
          ...
          style={{
            ...
            background: 'radial-gradient(50% 50%, color-mix(in oklab, var(--accent) 70%, transparent), transparent 72%)',
          }}
        />
      </div>
    </div>
